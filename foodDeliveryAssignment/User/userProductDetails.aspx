<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userProductDetails.aspx.cs" Inherits="foodDeliveryAssignment.User.productDetails" %>
                        ...
                        <div class="col-md-12">
                            <div class="mu-about-us-area">
                                ...
                                <div class="mu-title">
                                    ...
                                    <h2 class="registration-title-padding">Product Details</h2>
                                </div>
                                ...
                                <div class="row border-registration">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mu-about-us-right">
                                            ...
                                            <br />
                                            Description: <asp:Label ID="lblDescription" runat="server" Text="Label"></asp:Label>
                                            <br />
                                            Quantity: <asp:TextBox ID="txtQTY" runat="server" TextMode="Number"></asp:TextBox>
                                            <br />
                                            Price: <asp:Label ID="lblPrice" runat="server" Text="Label"></asp:Label>
                                            <br />
                                            <asp:Label ID="labelPID" runat="server" Text="Product ID: " Visible="false"></asp:Label>
                                            ...
                                            <asp:Button ID="btnCheckout" runat="server" Text="View Cart" OnClick="btnCheckout_Click" />
