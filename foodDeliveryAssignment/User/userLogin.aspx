<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userLogin.aspx.cs" Inherits="foodDeliveryAssignment.User.userLogin" %>
                        ...
                        <div class="col-md-12">
                            <div class="mu-about-us-area">
                                ...
                                <div class="mu-title">
                                    ...
                                    <h2 class="registration-title-padding">Login Form</h2>
                                </div>

                                <div class="row border-registration">
                                    <div class="col-md-6">
                                        <div class="mu-about-us-left">     
                                            <img src="../assets/img/profile-login-image.jpg" alt="img">           
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mu-about-us-right">
                                            ...
                                            <asp:Button ID="btnLogin" class="registration-button" runat="server" Text="Login" OnClick="btnLogin_Click1"/>
                                         
                                            <p class="sign-in-link">Don't have an account? <a class="register-hyperlink" href="userRegistration.aspx">Sign up</a>.</p>                                           
