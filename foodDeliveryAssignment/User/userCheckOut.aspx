<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userCheckOut.aspx.cs" Inherits="foodDeliveryAssignment.User.userCheckOut" %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="mu-title">
                            ...
                            <h2 class="registration-title-padding">Checkout</h2>
                         </div>
                            ...
                            <div class="col-sm-12 col-md-10 col-md-offset-1">
                                                        ...
                                                        <td class="col-sm-8 col-md-6">
                                                            <div class="media">
                                                                ...
                                                                &nbsp;<div class="media-body">
                                                                    ...
                                                                    <asp:Label ID="lblSCID" runat="server" Text='<%# Eval("scid") %>' Visible="true"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <table width="900px">
                                    <tr>
                                        ...
                                        <td>
                                             <asp:Button ID="btnPayNow" Cssclass="btn btn-success rounded-pill py-sm-3 px-sm-5 ms-3 check-out-btn" Text="Pay Now" runat="server" OnClick="btnPayNow_Click" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="col-md-12">
                            <div class="mu-footer-area">
                                ...
                                <div class="mu-footer-copyright">
                                    <p>&copy; Copyright ="nofollow" href="http://markups.io">markups.ioAll right reserved.</p>
                                </div>         
                            </div>
                        </div>
                    </div>
