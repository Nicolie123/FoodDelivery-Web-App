<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userOrderHistory.aspx.cs" Inherits="foodDeliveryAssignment.User.userOrderHistory" %>
                        ...
                        <div class="col-md-12">
                            <div class="mu-about-us-area">
                                ...
                                <div class="mu-title">
                                    ...
                                    <h2 class="registration-title-padding">Orders</h2>
                                </div>

                                <div class="row border-registration">
                                    <div class="col-md-6">
                                        <div class="mu-about-us-left">     
                                            <img src="../assets/img/bill.png" alt="img">           
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mu-about-us-right">
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    <asp:Panel ID="Panel1" runat="server" BackColor="#f8f9fa" BorderStyle="Solid" BorderWidth="1px" Padding="10px">
                                                        ReceiptID:
                                                        <asp:Label runat="server" Text='<%# Eval("RID") %>' />
                                                        &nbsp&nbsp&nbsp&nbsp
                                                        Grand Total:
                                                        <asp:Label runat="server" Text='<%# Eval("total", "{0:C}") %>' />
                                                        &nbsp&nbsp&nbsp&nbsp
                                                        Date Added:
                                                        <asp:Label runat="server" Text='<%# Eval("dtAdded", "{0:d}") %>' />
                                                        &nbsp&nbsp&nbsp&nbsp
                                                    </asp:Panel>
                                                </ItemTemplate>
                                            </asp:Repeater>                                           
