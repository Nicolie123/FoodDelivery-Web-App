<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shoppingCart.aspx.cs" Inherits="foodDeliveryAssignment.User.shoppingCart" %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="mu-title">
                            ...
                            <h2 class="registration-title-padding">Shopping Cart</h2>
                         </div>

                        <div class="row border-registration">
                            <div class="col-sm-12 col-md-10 col-md-offset-1">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FeastyDbsConnection %>" ></asp:SqlDataSource>
                                                    ...
                                                    <tr>
                                                        <td class="col-sm-8 col-md-6">
                                                            <div class="media">
                                                                ...
                                                                <asp:Image ID="Image1" CssClass="thumbnail pull-left" runat="server" ImageUrl='<%# Eval("picture") %>' style="width: 72px; height: 72px;" />
                                                       
                                                                &nbsp;<div class="media-body">
                                                                    <h4 class="media-heading"><a href="#"><%# Eval("name") %></a></h4>
                                                                    <h5 class="media-heading"><%# Eval("description") %></h5>
                                                                    <asp:Label ID="lblSCID" runat="server" Text='<%# Eval("scid") %>' Visible="False"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="col-sm-1 col-md-1" style="text-align: center">
                                                            <asp:TextBox ID="txtQTY" TextMode="Number" Text='<%# Eval("qty") %>' runat="server"></asp:TextBox>
                                                        </td>
                                                        ...
                                                        <td class="col-sm-1 col-md-1">
                                                            <asp:Button ID="Button1" CssClass="btn btn-success" runat="server" CommandName="updateItem" Text="Update" />
                                                            <asp:Button ID="Button2" CssClass="btn btn-danger" runat="server" CommandName="removeItem" Text="Remove" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <table width="900px">
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <h2><strong>RM<asp:Label ID="lblGT" runat="server" Text="Label"></asp:Label>
                                                 </strong></h2>
                                        </td>
                                        <td>
                                             <asp:Button ID="btnCheckOut" runat="server" Cssclass="btn btn-primary rounded-pill py-sm-3 px-sm-5 check-out-button" Text="Check Out" OnClick="btnCheckOut_Click"   /> &nbsp&nbsp
